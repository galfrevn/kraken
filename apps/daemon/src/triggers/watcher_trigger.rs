...
impl FileWatcherTriggerListener {
    ...
    async fn process_scheduler_event(
        ...
        if scheduler_event.trigger_type != TriggerType::FileChange {
            return;
        }
        ...
        let trigger_event = TriggerEvent {
            ...
            trigger_type: InternalTriggerType::FileChange,
...
mod tests {
    ...
    fn test_file_change_event_filtering_accepts_file_change_trigger_type() {
        let file_change_scheduler_event = SchedulerEvent {
            ...
            source: "file_change:src-watcher".to_string(),
            payload: None,
            timestamp: chrono::Utc::now(),
        };

        assert_eq!(
            file_change_scheduler_event.trigger_type,
    ...
    fn test_file_change_event_filtering_rejects_cron_trigger_type() {
        ...
        assert_ne!(cron_scheduler_event.trigger_type, TriggerType::FileChange);
    }
    ...
    fn test_trigger_event_creation_from_file_change_scheduler_event() {
        let scheduler_event = SchedulerEvent {
            ...
            trigger_type: TriggerType::FileChange,
            source: "file_change:config-watcher".to_string(),
            payload: None,
        ...
        assert_eq!(trigger_event.trigger_type, InternalTriggerType::FileChange);
        assert_eq!(trigger_event.source, "file_change:config-watcher");
    ...
    fn test_trigger_event_creation_from_file_change_event_with_payload() {
        let scheduler_event = SchedulerEvent {
            ...
            trigger_type: TriggerType::FileChange,
            source: "file_change:src-watcher".to_string(),
            payload: Some(serde_json::json!({"changed_path": "src/main.rs"})),
            timestamp: chrono::Utc::now(),
        };
